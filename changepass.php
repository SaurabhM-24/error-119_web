...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    $userId = $userData['id'];
    $query = "UPDATE er1 SET password = '$password' WHERE id = '$userId'";
    mysqli_query($conn, $query);
    header("location: sll.php");
    }else{
    ...
    <div class="center-block1">
        ...
        <div class="login-block">
            ...
            <div class="form-box">
            <form id="login" action="changepass.php" method="post">
                <label id="fname" for="fname">Enter New Password</label> <br>
                <input type="text" id="fname" name="password" ><br><br>


                <label id="fname" for="fname">Repeat Password</label> <br>
                <input type="text" id="fname" name="rpassword" ><br><br>

                <button type="submit" name="submit" id="submit-button">Create New Password <i class="bi bi-arrow-right"></i></button> 
              </form>
