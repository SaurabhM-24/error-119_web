...
if(isset($_REQUEST['msg']))
  ...
  if(isset($_POST['submit'])){
      $userId = $_POST['email'];
      $email = mysqli_query($conn, "SELECT * FROM er1 WHERE email = '$email'");
  ...
  ?>
    ...
    <div class="center-block1">
        ...
        <div class="login-block">
            ...
            <div class="form-box">
            <form id="login" action="send_otp_forget.php" method="post">
                <label id="fname" for="fname">E-mail</label> <br>
                <input type="text" id="fname" name="email"><br><br>

                <button type="submit" name="submit" id="submit-button">Send Verification Code <i class="bi bi-arrow-right"></i></button> 
              </form>
