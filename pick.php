  ...
  if (isset($_POST['pic'])) {
    ...
    <div class="grid-container">
        ...
        <div class="grid-item">
            ...
            <input type="submit" name="pic" class="livenow" id="livenow" value="284">LIVE NOW</input>
            </form>
        </div>
        </div>
        ...
        <div class="grid-item">
            ...
            <div class="button-container2">
                <button class="livenow" id="coming-soon" name=>Coming Soon &nbsp;<i class="bi bi-clock-fill"></i> </button>
            </div>
            <!-- <h2>Title 1</h2> -->
